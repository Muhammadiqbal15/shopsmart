    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Data User Aktif</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
      ...
      <!-- Main content -->
      <a href="<?= base_url() ?>Admin/Pdfuseraktif" class="btn btn-danger ml-3 mb-2"><i class="fas fa-file"></i> Export PDF</a>
      <a href="<?= base_url() ?>Admin/exceluseraktif" class="btn btn-success mb-2"><i class="fas fa-file"></i> Export EXCEL</a>
      <a href="<?= base_url() ?>Admin/printuseraktif" class="btn btn-primary mb-2"><i class="fas fa-print"></i> Print</a>
