    ...
    `<div class="wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Barang Belum Terkirim</h1>
                    </div>
                </div>
            </div>
        </div>

        <a href="<?= base_url() ?>Admin/Pdfbrgblmterkirim" class="btn btn-danger ml-3 mb-2"><i class="fas fa-file"></i> Export PDF</a>
        <a href="<?= base_url() ?>Admin/excelbrgblmterkirim" class="btn btn-success mb-2"><i class="fas fa-file"></i> Export EXCEL</a>
        <a href="<?= base_url() ?>Admin/printbrgblmterkirim" class="btn btn-primary mb-2"><i class="fas fa-print"></i> Print</a>
                        ...
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-bordered table-head-fixed table-responsive table-hover mt-3 " id="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($brgtdkterkirim as $btk) : ?>
                                        <tr>
                                            <td><?= ++$start; ?></td>
                                            <td><?= $btk['id']; ?></td>
                                            <td><?= $btk['nama_brg']; ?></td>
                                            <td><?= $btk['harga_brg']; ?></td>
                                            <td><?= $btk['jumlah_brg']; ?></td>
                                            <td><?= $btk['tot_hrg']; ?></td>
                                            <td><?= $btk['pengiriman']; ?></td>
                                            <td><?= $btk['pembayaran']; ?></td>
                                            <td><?= $btk['status_brg']; ?></td>
                                            <td><?= $btk['nama_pb']; ?></td>
                                            <td><?= $btk['notelp']; ?></td>
                                            <td><?= $btk['alamat']; ?></td>
                                            <td><?= $btk['provinsi']; ?></td>
